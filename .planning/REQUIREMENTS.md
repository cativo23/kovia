...
- [x] **ANIM-01**: Rescue staff can create, edit, and delete animal profiles
- [x] **ANIM-02**: Animal profile includes species, breed, age, size, energy level, and compatibility attributes
- [x] **ANIM-03**: Rescue staff can upload multiple photos per animal (cloud storage with presigned URLs)
- [x] **ANIM-04**: Animal has a status lifecycle: available -> in process -> adopted (with manual transitions)
...
- [x] **DASH-01**: Rescue staff can view and manage all animals for their organization
...
- [x] **LIST-01**: Anyone can browse available animals without creating an account
- [x] **LIST-02**: Public listings can be filtered by species, size, age, and organization
- [x] **LIST-03**: Public listing pages are server-side rendered for SEO
- [x] **LIST-04**: Animal detail pages include Open Graph meta tags for social media sharing
- [x] **LIST-05**: Each organization has a public landing page showing their available animals
